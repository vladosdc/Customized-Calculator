       ...
       let get_operatorPlus = document.getElementById('operator_plus')
        ...
        get_operatorMultiplication.addEventListener("click", function (event){
        ...
        get_operatorDivision.addEventListener("click", function (event){
            input_fields.value += get_operatorDivision.innerHTML;
        })

        let get_dot = document.getElementById('dot')
        get_dot.addEventListener("click", function (event){
